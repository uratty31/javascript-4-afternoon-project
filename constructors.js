...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  // function Movie(name, genre, rating) {
  //  let secondRating = 72; 
  //   Movie.prototype.changeRating = function(secondRating) {
  //     let rating = rating + secondRating / 2;
  //   }
  //   return rating;
  // }
 
  Movie.prototype.changeRating = function(secondRating) {
    let newRating = (this.rating + secondRating) / 2;
  ...
  User.prototype.changePostRating = function (id, newRating) {
    ...
    console.log(this.savedPosts[postIndex])
    console.log(this.savedPosts[postIndex].rating)
